# [SR-VIDEO-BK] Core Neurological Cognition Explainers

Thread title: [SR-VIDEO-BK] Core Neurological Cognition Explainers - v1.0 for review
Status: NOT STARTED
Owner: Paris Kulkarni | Authority: Rauhaan Bidri

## What
Template track for Core Neurological Cognition Explainers under SR-VIDEO-BK_Video-Motion-Content.
...
- One collateral = one thread. Tag [SR-VIDEO-BK] on everything.
