# [SR-DOC-BK] NDA IP Assignment Agreement

Thread title: [SR-DOC-BK] NDA IP Assignment Agreement - v1.0 for review
Status: V1.0 GENERATED - in All-Documents/ + output/ + Template-preview/
Owner: Paris Kulkarni | Authority: Rauhaan Bidri

## What
Template track for NDA IP Assignment Agreement under SR-DOC-BK_Documents-Official-Collateral.
