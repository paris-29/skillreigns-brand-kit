# [SR-DOC-BK] Course Completion Certificate Smart

Thread title: [SR-DOC-BK] Course Completion Certificate Smart - v1.0 for review
Status: V1.0 GENERATED - in All-Documents/ + output/ + Template-preview/
Owner: Paris Kulkarni | Authority: Rauhaan Bidri

## What
Template track for Course Completion Certificate Smart under SR-DOC-BK_Documents-Official-Collateral.
...
- One collateral = one thread. Tag [SR-DOC-BK] on everything.
