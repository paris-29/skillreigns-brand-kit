# [SR-BRANDING-BK] Smart NFC Cards ID Lanyards

Thread title: [SR-BRANDING-BK] Smart NFC Cards ID Lanyards - v1.0 for review
Status: NOT STARTED
Owner: Paris Kulkarni | Authority: Rauhaan Bidri

## What
Template track for Smart NFC Cards ID Lanyards under SR-BRANDING-BK_Brand-Merch-Physical.
...
- One collateral = one thread. Tag [SR-BRANDING-BK] on everything.
